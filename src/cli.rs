...
pub fn run_configure_flow(path: PathBuf) -> Result<PersistedConfig, String> {
    ...
    let config = PersistedConfig {
        ...
        brave_max_results,
        kagi_base_url: existing.kagi_base_url.clone(),
        kagi_api_key: existing.kagi_api_key.clone(),
        kagi_max_results: existing.kagi_max_results,
        search_backend: existing.search_backend.clone(),
        searxng_base_url: existing.searxng_base_url.clone(),
        crawl4ai_base_url: existing.crawl4ai_base_url.clone(),
        crawl4ai_api_token: existing.crawl4ai_api_token.clone(),
        crawl4ai_max_crawl_urls: existing.crawl4ai_max_crawl_urls,
        crawl4ai_content_max_chars: existing.crawl4ai_content_max_chars,
